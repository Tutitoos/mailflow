...
export const probeImapAccount = <ThrowOnError extends boolean = false>(options: Options<ProbeImapAccountData, ThrowOnError>): RequestResult<ProbeImapAccountResponses, ProbeImapAccountErrors, ThrowOnError> => (options.client ?? client).post<ProbeImapAccountResponses, ProbeImapAccountErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const connectImapAccount = <ThrowOnError extends boolean = false>(options: Options<ConnectImapAccountData, ThrowOnError>): RequestResult<ConnectImapAccountResponses, ConnectImapAccountErrors, ThrowOnError> => (options.client ?? client).post<ConnectImapAccountResponses, ConnectImapAccountErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/accounts/imap',
    ...options,
    headers: {
...
export const probeICloudAccount = <ThrowOnError extends boolean = false>(options: Options<ProbeICloudAccountData, ThrowOnError>): RequestResult<ProbeICloudAccountResponses, ProbeICloudAccountErrors, ThrowOnError> => (options.client ?? client).post<ProbeICloudAccountResponses, ProbeICloudAccountErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const connectICloudAccount = <ThrowOnError extends boolean = false>(options: Options<ConnectICloudAccountData, ThrowOnError>): RequestResult<ConnectICloudAccountResponses, ConnectICloudAccountErrors, ThrowOnError> => (options.client ?? client).post<ConnectICloudAccountResponses, ConnectICloudAccountErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/accounts/icloud',
    ...options,
    headers: {
...
export const discoverImapFolders = <ThrowOnError extends boolean = false>(options: Options<DiscoverImapFoldersData, ThrowOnError>): RequestResult<DiscoverImapFoldersResponses, DiscoverImapFoldersErrors, ThrowOnError> => (options.client ?? client).post<DiscoverImapFoldersResponses, DiscoverImapFoldersErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const refreshAccountCredentials = <ThrowOnError extends boolean = false>(options: Options<RefreshAccountCredentialsData, ThrowOnError>): RequestResult<RefreshAccountCredentialsResponses, RefreshAccountCredentialsErrors, ThrowOnError> => (options.client ?? client).post<RefreshAccountCredentialsResponses, RefreshAccountCredentialsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getMicrosoftOAuthStatus = <ThrowOnError extends boolean = false>(options?: Options<GetMicrosoftOAuthStatusData, ThrowOnError>): RequestResult<GetMicrosoftOAuthStatusResponses, GetMicrosoftOAuthStatusErrors, ThrowOnError> => (options?.client ?? client).get<GetMicrosoftOAuthStatusResponses, GetMicrosoftOAuthStatusErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/oauth/microsoft/status',
    ...options
});

export const startMicrosoftOAuth = <ThrowOnError extends boolean = false>(options?: Options<StartMicrosoftOAuthData, ThrowOnError>): RequestResult<StartMicrosoftOAuthResponses, StartMicrosoftOAuthErrors, ThrowOnError> => (options?.client ?? client).post<StartMicrosoftOAuthResponses, StartMicrosoftOAuthErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const completeMicrosoftOAuth = <ThrowOnError extends boolean = false>(options: Options<CompleteMicrosoftOAuthData, ThrowOnError>): RequestResult<unknown, CompleteMicrosoftOAuthErrors, ThrowOnError> => (options.client ?? client).get<unknown, CompleteMicrosoftOAuthErrors, ThrowOnError>({ url: '/oauth/microsoft/callback', ...options });
...
export const resolveAdminDeadLetter = <ThrowOnError extends boolean = false>(options: Options<ResolveAdminDeadLetterData, ThrowOnError>): RequestResult<ResolveAdminDeadLetterResponses, ResolveAdminDeadLetterErrors, ThrowOnError> => (options.client ?? client).post<ResolveAdminDeadLetterResponses, ResolveAdminDeadLetterErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getAdminAlerts = <ThrowOnError extends boolean = false>(options?: Options<GetAdminAlertsData, ThrowOnError>): RequestResult<GetAdminAlertsResponses, GetAdminAlertsErrors, ThrowOnError> => (options?.client ?? client).get<GetAdminAlertsResponses, GetAdminAlertsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/admin/alerts',
    ...options
});

export const testAdminAlert = <ThrowOnError extends boolean = false>(options: Options<TestAdminAlertData, ThrowOnError>): RequestResult<TestAdminAlertResponses, TestAdminAlertErrors, ThrowOnError> => (options.client ?? client).post<TestAdminAlertResponses, TestAdminAlertErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
